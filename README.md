...
Installation, API-Key erzeugen und häufige Fragen — alles dort.

## 💬 Fragen, Bugs, Ideen

- **Frage stellen** → [Q&A-Discussions](https://github.com/yves-vogl/moneymoney-paypal-pos-extension/discussions/categories/q-a)
- **Bug oder Vorschlag** → [Issues](https://github.com/yves-vogl/moneymoney-paypal-pos-extension/issues)
- **Sicherheitslücke (privat)** → siehe [SECURITY.md](SECURITY.md)
